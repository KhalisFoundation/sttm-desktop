#### 0.1.8 - 2017-04-03
##### Inconvenience
- Apologies to our pre-0.1.8 users, who had to re-install to take advantage of the new, much better build system that will allow us to do even more with the app.

##### Improved
- Messaging updated to better reflect download status
- Major under-the-hood updates using a better build system that will allow us to offer the app more easily on more platforms
...
- Settings
	...
	- *Close button* - Oh, you wanted to be able to close the settings after you opened them? Well, there's an × button to be able to do that, now. BTW, you can use the "esc" key as well.
