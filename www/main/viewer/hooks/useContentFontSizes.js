 ...
 * into whichever slot the reader has assigned them, so each needs all three
 * sizes to index by position. Reading them once here keeps the per-view choice
 * (see `font-sizes.js`) in one place and stops the three components drifting
 * apart.
 *
